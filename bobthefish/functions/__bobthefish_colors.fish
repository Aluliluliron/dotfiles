function __bobthefish_colors -S -a color_scheme -d 'Define colors used by bobthefish'
  switch "$color_scheme"
    ...
    case 'base16' 'base16-dark'
      ...
      set -l base06 d3d0c8
      set -l base07 d3d0c8
      set -l base08 f2777a # red
      set -l base09 ffcc66 # orange
      set -l base0A ffcc66 # yellow
      set -l base0B 99cc99 # green
      set -l base0C 66cccc # cyan
      set -l base0D 6699cc # blue
      set -l base0E cc99cc # violet
      set -l base0F d27b53 # brown
